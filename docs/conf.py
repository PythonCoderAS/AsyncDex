...
if True:  # To stop linters from resorting
    from asyncdex import version

# -- Project information -----------------------------------------------------

project = "AsyncDex"
copyright = "2021, PythonCoderAS"
...
# ones.
extensions = ["sphinx.ext.autodoc", "sphinx.ext.intersphinx", "sphinx_rtd_theme", "sphinx.ext.viewcode"]
